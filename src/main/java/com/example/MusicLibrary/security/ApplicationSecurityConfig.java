...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/music/user").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/v1/music/user").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/api/v1/music/user").hasAnyRole("ADMIN")
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/music/all").hasAnyRole("ADMIN", "USER")
                .antMatchers(HttpMethod.GET, "/api/v1/music/filename/**").hasAnyRole("ADMIN", "USER")
                .antMatchers(HttpMethod.GET, "/api/v1/music/id/**").hasAnyRole("ADMIN", "USER")
                .antMatchers(HttpMethod.POST, "/api/v1/music/upload").hasAnyRole("ADMIN")
